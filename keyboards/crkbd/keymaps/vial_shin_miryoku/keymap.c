...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   /***/   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        QK_GESC, KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,      /***/   KC_J,    KC_L,    KC_U,    KC_Y,    KC_QUOT, KC_NO,
    ...
    //  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   /***/   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        KC_NO,   KC_F12,  KC_F7,   KC_F8,   KC_F9,   KC_PSCR,   /***/   KC_NO,   KC_NO,   KC_NO,   KC_NO,   QK_BOOT, DF(_GAM),
    ...
    //  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   /***/   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        KC_ESC,  KC_NO,   KC_Q,    KC_W,    KC_E,    KC_R,      /***/   KC_NO,   KC_NO,   KC_UP,   KC_NO,   KC_TAB,  KC_NO,
        KC_NO,   KC_RSFT, KC_A,    KC_S,    KC_D,    KC_F,      /***/   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_RSFT, KC_NO,
        KC_NO,   KC_RCTL, KC_Z,    KC_X,    KC_C,    KC_V,      /***/   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_RCTL, KC_NO,
                                   KC_LALT, KC_SPC,  L_GFN,     /***/   DF(_CMK),KC_SPC,  KC_NO
    ),

    [_GFN] = LAYOUT_split_3x6_3(
    //  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   /***/   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        _______, KC_5,    KC_1,    KC_2,    KC_3,    KC_4,      /***/   KC_NO,   KC_NO,   KC_UP,   KC_NO,   KC_TAB,  KC_NO,
        KC_NO,   KC_0,    KC_6,    KC_7,    KC_8,    KC_9,      /***/   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_RSFT, KC_NO,
        KC_NO,   KC_G,    KC_J,    KC_I,    KC_M,    KC_T,      /***/   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_RCTL, KC_NO,
